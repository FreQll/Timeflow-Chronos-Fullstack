      ...
      <div className="flex items-center">
        <div className="relative flex items-center rounded-md bg-white shadow-sm md:items-stretch">
          <button
            onClick={prevHandler}
            type="button"
            className="flex h-9 w-12 items-center justify-center rounded-l-md border-y border-l border-gray-300 pr-1 text-gray-400 hover:text-gray-500 focus:relative md:w-9 md:pr-0 md:hover:bg-gray-50 text-nowrap"
          >
            <span className="sr-only">
              Previous {scheduleMode.toLocaleLowerCase()}
            </span>
            <svg
              className="h-5 w-5"
              viewBox="0 0 20 20"
          ...
          <button
            onClick={nextHandler}
            type="button"
            className="flex h-9 w-12 items-center justify-center rounded-r-md border-y border-r border-gray-300 pl-1 text-gray-400 hover:text-gray-500 focus:relative md:w-9 md:pl-0 md:hover:bg-gray-50 text-nowrap"
          >
        ...
        <div className="hidden md:ml-4 md:flex md:items-center">
          <div className="relative">
            <button
              ...
              type="button"
              className="flex items-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 text-nowrap"
              id="menu-button"
              aria-expanded="false"
              aria-haspopup="true"
            >
            ...
            {menuViewOpen && (
              ...
              >
                <div className="py-1" role="none">
                  <a
                    href="#"
                    onClick={() => handleClickMode(enumScheduleModes.DAY)}
                  ...
                  <a
                    href="#"
                    onClick={() => handleClickMode(enumScheduleModes.MONTH)}
                    className="text-gray-700 block px-4 py-2 text-sm"
                    role="menuitem"
                    tabIndex="-1"
                    id="menu-item-2"
