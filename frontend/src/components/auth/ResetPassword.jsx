...
const ResetPassword = ({ active, setActive }) => {
  ...
  const handleClickNext = async () => {
    ...
    if (response.data.length == 0) {
      ...
      await axios.post("/api/auth/reset-password", data, POST_CONFIG);
    }
  };
      ...
      <div
        className={`flex flex-col items-center justify-center gap-[20px] text-center py-[20px] px-[40px]
            ...
            ${
              ...
              "z-[6] translate-x-[150%] opacity-100"
            }
      ...
      >
        <div>
          ...
          <div className="text-[14px] opacity-60">
            Use your email for reset password
          </div>
        </div>
      ...
      <div
        className={`flex flex-col items-center justify-center gap-[20px] text-center py-[20px] px-[40px]
            ...
            ${
              active == "reset_password" &&
              state == "confirm_code" &&
              "z-[6] translate-x-[100%] opacity-100"
            }`}
      >
        <div>
          <h1 className="uppercase text-[#7B6CEA] font-[600] text-[24px]">
          ...
          <div className="text-[14px] opacity-60">
            Check your mail, enter code and reset password
          </div>
        </div>
        <form className="flex flex-col gap-[10px] w-[100%]">
