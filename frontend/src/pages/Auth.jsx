  ...
  return (
    <div className="w-[100vw] h-[100vh] bg_gradient flex align-center justify-center">
      <div className="relative min-w-[900px] min-h-[500px] self-center bg-white rounded-[10px] overflow-hidden box_shadow">
        <div
          className={`absolute top-0 left-[0] h-[100%] w-[60%] bg-[url(./images/form_bg.png)] bg-cover form_transition z-[8]
          ${active == "login" && "translate-x-[67%]"}`}
        ></div>

        <div
          className={`absolute top-0 left-[0] h-[100%] w-[100%] bg-white form_transition z-[2]`}
        ></div>
        ...
        >
          <div>
            <h1 className="uppercase text-white font-[600] text-[36px]">
              Join our calendar
            </h1>
            <div className="text-[14px] opacity-60 text-white">
              Simply fill out the registration form and start organizing your
              life.
            </div>
          </div>
        ...
        <div
          className={`flex flex-col gap-[20px] py-[20px] px-[40px] mt-[10%] text-left
          absolute top-0 left-[100%] h-[100%] w-[60%] opacity-0 z-[10] form_transition ${
            active == "login" && "translate-x-[-100%] opacity-100"
          }`}
        >
          <div>
            <h1 className="uppercase text-white font-[600] text-[36px]">
            ...
            <div className="text-[14px] opacity-60 text-white">
              Enter your credentials and log in to your account to access your
              calendar.
            </div>
          </div>
          <div className="flex gap-[10px] items-center">
        ...
        <div
          className={`flex flex-col gap-[20px] py-[20px] px-[40px] mt-[10%] text-left
          absolute top-0 left-[-60%] h-[100%] w-[60%] form_transition z-[9] opacity-0 ${
            active == "reset_password" && "translate-x-[100%] opacity-100"
          }`}
        >
          <div>
            <h1 className="uppercase text-white font-[600] text-[36px]">
            ...
            <div className="text-[14px] opacity-60 text-white">
              No worries, we've got you covered. Enter your email address to get
              six-digit code, reset your password and regain access to your
              calendar.
            </div>
          </div>
          <div className="flex gap-[10px] items-center">
